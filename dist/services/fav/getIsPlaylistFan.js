...
exports.default = async ({ disstids = [], } = {}) => {
    ...
    if (!okBatches) {
        (0, observability_1.logServiceFailure)('getIsPlaylistFan', UPSTREAM_URL, firstError, { count: tids.length });
        return {
            status: 500,
            body: {
                response: {
    ...
    if (okBatches < batches.length) {
        (0, observability_1.logServiceFailure)('getIsPlaylistFan', UPSTREAM_URL, firstError, {
            count: tids.length,
            okBatches,
    ...
    (0, observability_1.logServiceSuccess)('getIsPlaylistFan', UPSTREAM_URL, {
        code: response.code,

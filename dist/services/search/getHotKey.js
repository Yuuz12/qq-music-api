...
exports.default = ({ method = 'get', params = {}, option = {} }) => {
    ...
    (0, observability_1.logServiceRequest)('getHotKey', upstream, data);
    return (0, y_common_1.default)({
        ...
        (0, observability_1.logServiceSuccess)('getHotKey', upstream, response);
        return {
            status: 200,
            body: {
                response,
        ...
        .catch((error) => {
        (0, observability_1.logServiceFailure)('getHotKey', upstream, error, data);
        return {
            status: 500,
            body: {
                error,

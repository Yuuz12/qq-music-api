...
exports.apiExplorerOverrides = {
    ...
    getRadioTrack: {
        id: 'get-radio-track',
        description: 'Get radio track list. id=99 is 猜你喜欢 (private FM), other ids are category radio.',
        queryParams: [
            {
                key: 'id',
                label: 'Radio ID',
    ...
    radioDislike: {
        id: 'radio-dislike',
        description: 'Radio delete button: mirrors the web stat report only (fcg_val_report.fcg). The real queue removal must be done client-side.',
    ...
    setFav: {
        id: 'set-fav',
        description: 'Add/remove favorite songs or add songs to a user playlist. dirId=201 is 我喜欢; for 自建歌单 use the internal dirId from getUserProfile.disslist[].dirId (NOT dissid, which returns 80092). isFan=true removes (DelSonglist), false adds (AddSonglist).',
    ...
    setAlbumFav: {
        id: 'set-album-fav',
        description: 'Favorite/unfavorite an album via music.musicasset.AlbumFavWrite (FavAlbum / CancelFavAlbum). isFan=true cancels, false favorites. Requires login cookie; write goes through the official-channel proxy (npm run proxy).',
    ...
    getIsSongFan: {
        id: 'get-is-song-fan',
        description: 'Batch check favorite state (red heart) by song mids via music.musicasset.SongFavRead.',
    ...
    getIsAlbumFan: {
        id: 'get-is-album-fan',
        description: 'Batch check album favorite state by album mids via music.musicasset.AlbumFavRead (IsAlbumFan).',
    ...
    setPlaylistFav: {
        id: 'set-playlist-fav',
        description: 'Favorite/unfavorite a playlist via music.musicasset.PlaylistFavWrite (FavPlaylist / CancelFavPlaylist). isFan=true cancels, false favorites. Requires login cookie; write goes through the official-channel proxy (npm run proxy).',
    ...
    getIsPlaylistFan: {
        ...
        description: 'Batch check playlist favorite state by disstids via music.musicasset.PlaylistFavRead (IsPlaylistFan).',
    ...
    getUserFavDiss: {
        ...
        description: 'Get user collected playlists (收藏歌单): same item shape as getUserProfile.disslist.',
        queryParams: [
            {
                key: 'sin',
                label: 'Start offset',
    ...
    getUserFavAlbum: {
        ...
        description: 'Get user collected albums (我喜欢→专辑): albummid/title/singername/picurl/pubtime. Same upstream as getUserFavDiss with reqtype=2.',
        queryParams: [
            {
                key: 'sin',
                label: 'Start offset',
    ...
    getRelationList: {
        ...
        description: 'Get user relation list (关注歌手/关注用户/粉丝) via music.concern.RelationList. hostUin empty = current login user. Requires cookie.',
        queryParams: [
            {
                key: 'type',
                label: 'Type',

...
import { isRelationListType, type RelationListType } from '../services/user/getRelationList';

const { getRelationList } = services;
...
export default async (ctx: Context) => {
  ...
  const type: RelationListType = rawType;
